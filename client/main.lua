...
RegisterNetEvent('esx:setStorePoint')
AddEventHandler('esx:setStorePoint',function(quantity)
	ESX.PlayerData.storepoint = quantity
	ESX.SetPlayerData('storepoint', ESX.PlayerData.storepoint)
end)
